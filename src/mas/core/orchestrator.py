"""Minimal orchestration helpers with ingest -> correlation -> rca state handoff."""
...
def run_once(
    *,
    ...
    """Run ingest, and optionally correlation and RCA in sequence."""
    state: GlobalState = {}
...
def main(argv: list[str] | None = None) -> int:
    """CLI entry for ingest/correlation/rca handoff."""
    parser = argparse.ArgumentParser(description="Run orchestrator ingest/correlation/rca handoff.")
    ...
    if args.correlation_file and args.ingest_file:
